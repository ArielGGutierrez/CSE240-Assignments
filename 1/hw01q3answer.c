...
int main(){
   ...
   printf("y is %d\n",y);
	...
	printf("Error Type: Contextual \n\n");
     ...
     printf("This is a contextual error because the root of the problem lies in  how the print statement looked for the ascii value for 100 rather than the number itself.  Thus, this has something to do with type inconsistency. \n\n");
	// Problem 4: (2 points)
